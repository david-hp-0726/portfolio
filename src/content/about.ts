...
export const ABOUT: AboutSection = {
    ...
    body: [
        ...
        "I started college with a passion for building interactive experiences on the web - websites, tools, and servers that people could engage with through a screen. Over time, that passion expanded from the digital to the physical: I wanted to build systems that sense and act in the physical world. That led me to robotics, where code and models can produce tangible motion on a physical machine. At Emory, I built a foundation in algorithms, machine learning, and optimization, and at Georgia Tech, I’ve applied those skills to hands-on robotics projects",
